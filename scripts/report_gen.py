...
<head>
  ...
  <title>NSHE Report — {xml_escape(target)}</title>
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;500;600;700&family=Fira+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet" />
  <script src="https://cdn.tailwindcss.com"></script>
  <script>tailwind.config={{darkMode:'class',theme:{{extend:{{fontFamily:{{sans:['Fira Sans','system-ui','sans-serif'],mono:['Fira Code','monospace']}},colors:{{nshe:{{bg:'#020617',surface:'#0F172A',surface2:'#1E293B',accent:'#22C55E',danger:'#EF4444',warning:'#F59E0B',text:'#F8FAFC',muted:'#94A3B8',border:'#334155'}}}}}}}}}}</script>
  <style>
...
<body>
  <div style="max-width: 1280px; margin: 0 auto; padding: 24px 16px;">
    ...
    <footer style="border-top: 1px solid #334155; padding-top: 24px; text-align: center; font-size: 12px; color: #94A3B8;">
      <p>NSHE Report — Generated by NSHE on {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>
    </footer>
  </div>
</body>
</html>'''
...
def generate_pdf_report(output_path=None):
    ...
    pdf.cell(0, 15, 'NSHE Scan Report', new_x='LMARGIN', new_y='NEXT')
